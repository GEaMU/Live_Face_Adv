...
#from lib.module.offsetGaussianHeadModule import GaussianHeadModule
from lib.module.GaussianHeadModule import GaussianHeadModule
# from lib.module.advGaussianHeadModule import advGaussianHeadModule
...
if __name__ == '__main__':
    ...
    camera = CameraModule()
    recorder = ReenactmentRecorder(cfg.recorder,arg.index)
